...
public class AttributeSelectionTest {
  ...
  protected static void useClassifier(Instances data) throws Exception {
    ...
    //J48 base = new J48();
    LinearRegression base = new LinearRegression();
  ...
  public static void main(String[] args) throws Exception {
    ...
    //String location = "D:/Program Files (x86)/Weka-3-7/data/iris.arff";
    String location = "F:/study/Experiment/Liberty Mutual Group Property Inspection Prediction/train.csv.arff";
