 ...
 * well as demo.classification or regression.
 * 
...
public class ExperimentDemo {
   ...
   *   <li>-exptype "demo.classification|regression"</li>
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length == 0) {
	  ...
	  + "\t   -exptype <demo.classification|regression>\n"
    ...
    // demo.classification or regression
    ...
    if (option.equals("demo.classification")) {
      classification = true;
